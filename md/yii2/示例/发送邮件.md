...
* 使用
    ...
    * 使用示例
        ...
        $mailer->setFrom('myntmessagebox@outlook.com');  //发件邮箱(可能与发件服务器登录帐号不同)。可使用关联数组形式,其中键为邮箱地址,值为发件人的名称 
        $mailer->setTo('161710988@qq.com');              //收件人。指定多个时可使用数组
        $mailer->setCc('160235263@qq.com');              //抄送人。指定多个时可使用数组
        $mailer->setBcc('160235263@qq.com');             //密送人。指定多个时可使用数组
