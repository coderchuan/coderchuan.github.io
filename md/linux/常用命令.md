...
* 压缩与解压缩
    * 后缀`tar.gz`
        * 查看列表:`tar -tzvf  文件名.tar.gz`
        * 压缩:`tar -czvf  保存的压缩文件名.tar.gz  要压缩的目录`
        * 解压缩:`tar -xzvf  要解压的文件名.tar.gz`
    * 后缀`tar`
        * 查看列表:`tar -tvf  文件名.tar`
        * 压缩:`tar -cvf  保存的压缩文件名.tar  要压缩的目录`
        * 解压缩:`tar -xvf  要解压的文件名.tar`
