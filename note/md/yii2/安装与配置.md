...
* 前提
    ...
    * 安装`php-gd`扩展 
    * 安装`php-mbstring`扩展 
    * 获取`github token`，可用`198b4df248d6587f1f546f47de97c3f9488eb5ad`(2020年06月04日)
* 创建基础Yii项目
    1. 执行命令`composer create-project --prefer-dist yiisoft/yii2-app-basic DIR_NAME`，其中`DIR_NAME`为文件夹名，将会在当前目录下新建一个名为`DIR_NAME`的文件夹，其中包含着YII项目文件
